...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-blue w3-card w3-left-align w3-large">
            ...
            <a class="w3-bar-item w3-button w3-padding-large w3-white">Citas</a>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $value['tipo_cita'] ?></td>
                                <td><?php echo $value['lugar_cita'] ?></td>
                                <td><?php echo $value['direccion_cita'] ?></td>
                                <td><?php echo $value['fecha_cita'] ?></td>
                                <td><?php echo $value['hora_cita'] ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
